...
ALTER TABLE "employee_tags" ADD CONSTRAINT "employee_tags_employee_id_employees_employee_id_fk" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("employee_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "unit_assignments" ADD CONSTRAINT "unit_assignments_employee_id_employees_employee_id_fk" FOREIGN KEY ("employee_id") REFERENCES "public"."employees"("employee_id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_unit_assignments_employee" ON "unit_assignments" USING btree ("employee_id");--> statement-breakpoint
